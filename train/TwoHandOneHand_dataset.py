...
gesture = {
    0:'write', 1:'keyboard', 2:'smartphone', 3:'onehandpoint', 4:'V'
} # 3 two hand Gestures
...
file = np.genfromtxt('/home/jun/Mediapipe-handpose/data/train_data/twohandonehand_gesture_train.csv', delimiter=',')
        ...
        for res in result.multi_hand_landmarks :
            for idx, hand_handedness in enumerate(result.multi_handedness):
                if len(handedness) == 1:
                    ...
                    dataA = np.append(dataA, i)
                    dataB = np.append(dataB, i)
                    Alldata = np.vstack((dataA, dataB))
...
np.savetxt('/home/jun/Mediapipe-handpose/data/train_data/twohandonehand_gesture_train.csv', file, fmt='%s', delimiter=',')
